                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="p-6 border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-gray-50">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="px-2 py-1 rounded-md bg-green-50 text-green-700 text-xs font-medium border border-green-100">Connected</span>
                        </div>
                        <p className="text-sm text-gray-500 mb-4">PO retrieval, vendor invoice creation, payment trigger, status sync</p>
                        <button className="text-sm text-primary font-medium hover:underline">Configure Mapping</button>
                    </div>
                    ...
                    <div className="p-6 border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-gray-50">
                        ...
                        <button className="text-sm text-primary font-medium hover:underline">Configure API</button>
                    </div>
                    ...
                    <div className="p-6 border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-gray-50">
                        <div className="flex justify-between items-start mb-4">
                            ...
                            <span className="px-2 py-1 rounded-md bg-green-50 text-green-700 text-xs font-medium border border-green-100">Active</span>
                        </div>
                        <p className="text-sm text-gray-500 mb-4">Document ingestion, metadata management</p>
                        <button className="text-sm text-primary font-medium hover:underline">Configure Library</button>
                    </div>
                    ...
                    <div className="p-6 border border-gray-100 rounded-2xl bg-gradient-to-br from-white to-gray-50">
                        ...
                        <button className="text-sm text-primary font-medium hover:underline">Edit Server</button>
                    </div>
                </div>
            </section>
