const { getPurchaseOrder, getAnnexureByPO } = require('./erpService');

/**
 * Performs a 3-way match: Invoice vs. Purchase Order vs. Ringi Annexure
 * FR-4: Verify Amount, Line Items, and Tolerance (±5%)
 */
const performThreeWayMatch = async (invoiceData) => {
